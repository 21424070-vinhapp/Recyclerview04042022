...
public class FoodModel {
    ...
    public static List<FoodModel> getMock()
    {
        return new ArrayList<>(Arrays.asList(
                ...
                new FoodModel(R.drawable.image_saycoffee,"Yến Sào Trời Nam - Tổ Yến Chưng Sẵn Tự Chọn ","8 Nguyễn Huy Lượng, P. 14, Bình Thạnh, TP. HCM, TP. HCM",Arrays.asList(ServiceEnum.RESTAURANT,ServiceEnum.BIRTHDAY),new Discount(DiscountSessionEnum.ALL_TIME,"Giảm 5%"),Ultils.getTime(7,0,0),Ultils.getTime(22,0,0),13,true),
                new FoodModel(R.drawable.image_sumobbq,"Ăn Vặt Mr. Phương - Đường Số 19","4 Đường Số 19, P. 4, Quận 4, TP. HCM",Arrays.asList(ServiceEnum.RESTAURANT,ServiceEnum.BIRTHDAY),new Discount(DiscountSessionEnum.ALL_TIME,"Giảm 20%"),Ultils.getTime(7,0,0),Ultils.getTime(22,0,0),13,true),
                new FoodModel(R.drawable.image_sushibar,"Anzi - Cơm Trưa Văn Phòng","2/15 Quách Văn Tuấn, P. 12, Tân Bình, TP. HCM",Arrays.asList(ServiceEnum.RESTAURANT,ServiceEnum.BIRTHDAY),new Discount(DiscountSessionEnum.MORNING,"Giảm 20%"),Ultils.getTime(7,0,0),Ultils.getTime(22,0,0),13,true),
